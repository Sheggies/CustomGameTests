...
function sm.physics.raycast(startPos, endPos, body, mask) end
...
---@return boolean,	RaycastResult
function sm.physics.raycastTarget(startPos, endPos, body) end
...
---@param mask? integer The collision mask. Defaults to [sm.physics.filter, sm.physics.filter.default] (Optional)
---@return boolean,	RaycastResult
function sm.physics.spherecast(startPos, endPos, radius, body, mask) end
